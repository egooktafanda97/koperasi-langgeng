...
@section('content')
    <div class="container-fluid !p-0 text-gray-700">
        <div class="m-2 flex justify-between">
            ...
            <a class="btn btn-primary" href="{{ route('pengumuman.create') }}">
            ...
            columns: ["No", "Judul",
                {
                    ...
                    formatter: (cell, row) => {
                        return gridjs.html(`
                            <a href="/pengumuman/edit/${row.cells[2].data}" class="btn btn-sm btn-primary">
                                <i class="fas fa-edit"></i>
                            </a>
                            <button onclick="deleted('/pengumuman/${row.cells[2].data}/destroy')" class="btn btn-sm btn-danger">
