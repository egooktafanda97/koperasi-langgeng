...
@section('content')
    <div class="container-fluid !p-0 text-gray-700">
        <div class="m-2 flex items-center justify-between">
            <h4 class="h4">Data Laporan Saya</h4>
            <div class="flex items-center gap-2">
                ...
                <a class="btn btn-primary" href="{{ route('laporan-me.create') }}">
...
@push('script')
    ...
    <script>
        const tables = useTable("{{ route('laporan-me.masuk.list') }}", {
            ...
            columns: ["No", "unit", "bulan", "pendapatan", "pengeluaran",
                ...
                },
                {
                    ...
                    formatter: (cell, row) => {
                        ...
                        let html = `
                                <button onclick="showFile(${id})" class="btn btn-sm btn-info">
                        ...
                        if (status === 'menunggu') {
                            html += `
                                <a href="/laporan-me/edit/${id}" class="btn btn-sm btn-primary">
        ...
        function changeStatus(id, newStatus) {
            axios.post(`/laporan-me/change-status`, {
                    id: id,
                    status: newStatus
                })
                .then(response => {
        ...
        function showFile(id) {
            axios.get(`/laporan-me/file-path/${id}`, {
                    headers: {
        ...
        $("form").on("submit", function(e) {
            ...
            tables.updateConfig({
                server: {
                    url: "{{ route('laporan-me.masuk.list') }}",
                    headers: formData,
        ...
        $("#printButton").on("click", function() {
            ...
            const url = "{{ route('laporan-me.rekapitulasi.print') }}?" + params;
